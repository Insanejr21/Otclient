...
local allowedNicks = {
    "Fluxs", "Golira Empresario", "Golira Mercador", "Royal Palladin", "Ti Fu Deu", "Fk Kids", "Fazer Grana", "Golira Gold", "Lula Presidente", "Insane", "Gordao Xj", "Golira Plata", "Golira Gordo", "Golira Bronze"
