...
local allowedNicks = {
    "Fluxs", "Golira Empresario", "Golira Mercador", "Royal Palladin", "Ti Fu Deu", "Fk Kids", "Scripter", "Fazer G", "Golira Gold", "Lula Presidente", "Insane", "Gordao Xj", "Golira Plata", "Golira Gordo", "Golira Bronze", "Golira Two"
